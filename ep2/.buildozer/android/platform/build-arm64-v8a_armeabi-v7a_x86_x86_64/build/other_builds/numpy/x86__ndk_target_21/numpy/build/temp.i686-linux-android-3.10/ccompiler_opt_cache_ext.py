...
{'cache_infile': True,
 'cache_me': {"('cc_test_flags', ['-O3'])": True,
              ...
              "('feature_flags', ('FMA3', 'AVX2'))": ['-msse', '-msse2',
                                                      ...
                                                      '-mf16c', '-mfma',
                                                      '-mavx2'],
              "('feature_flags', {'SSE', 'SSE2'})": ['-msse', '-msse2'],
 ...
 'feature_supported': {'AVX': {'flags': ['-mavx'],
                       ...
                       'XOP': {'flags': ['-mxop'],
                               ...
                               'interest': 9}},
 'hit_cache': True,
 'parse_baseline_flags': ['-msse', '-msse2'],
 'parse_baseline_names': ['SSE', 'SSE2'],
 'parse_dispatch_names': ['SSE3', 'SSSE3', 'SSE41', 'POPCNT', 'SSE42', 'AVX',
                          'F16C', 'FMA3', 'AVX2', 'AVX512F', 'AVX512CD',
                          'AVX512_KNL', 'AVX512_SKX', 'AVX512_CLX',
 ...
 'parse_target_groups': {'SIMD_TEST': (True,
                                       ['AVX512_SKX', 'AVX512F',
                                        ('FMA3', 'AVX2'), 'SSE42'],
                                       [])},
 'sources_status': {'build/src.i686-linux-android-3.10/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                                ['AVX512_SKX',
                                                                                                 'AVX512F',
                                                                                                 ('FMA3',
                                                                                                  'AVX2'),
                                                                                                 'SSE42']),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                          ['AVX512F',
                                                                                                           'AVX2']),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                           ['AVX512_SKX',
                                                                                                            'AVX512F',
                                                                                                            'AVX2',
                                                                                                            'SSE41']),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                             ['AVX512_SKX',
                                                                                                              'AVX512F',
                                                                                                              ('FMA3',
                                                                                                               'AVX2')]),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                              ['AVX512F',
                                                                                                               ('FMA3',
                                                                                                                'AVX2')]),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                         ['AVX512_SKX']),
                    'build/src.i686-linux-android-3.10/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                         ['SSE41']),
