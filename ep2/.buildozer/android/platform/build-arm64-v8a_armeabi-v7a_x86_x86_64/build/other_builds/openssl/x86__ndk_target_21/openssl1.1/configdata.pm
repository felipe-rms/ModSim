...
our %config = (
  ...
  CFLAGS => [ "-target i686-linux-android21 -fomit-frame-pointer -march=i686 -mssse3 -mfpmath=sse -m32 -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [ "-DANDROID -I/home/lilipe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/lilipe/Documents/graduacao/modsim/ep2/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a_x86_x86_64/build/python-installs/myapp/x86/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/home/lilipe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target i686-linux-android21 -fomit-frame-pointer -march=i686 -mssse3 -mfpmath=sse -m32 -fPIC",
  CXXFLAGS => [ "-target i686-linux-android21 -fomit-frame-pointer -march=i686 -mssse3 -mfpmath=sse -m32 -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)i686-linux-android21-clang",
  minor => "1.1",
  ...
  perl_version => "5.36.1",
  perlargv => [ "shared", "no-dso", "no-asm", "android-x86", "-D__ANDROID_API__=21" ],
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/lilipe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
