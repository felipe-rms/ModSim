...
our %config = (
  ...
  CFLAGS => [ "-target x86_64-linux-android21 -fomit-frame-pointer -march=x86-64 -msse4.2 -mpopcnt -m64 -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [ "-DANDROID -I/home/lilipe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/lilipe/Documents/graduacao/modsim/ep2/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a_x86_x86_64/build/python-installs/myapp/x86_64/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/home/lilipe/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target x86_64-linux-android21 -fomit-frame-pointer -march=x86-64 -msse4.2 -mpopcnt -m64 -fPIC",
  CXXFLAGS => [ "-target x86_64-linux-android21 -fomit-frame-pointer -march=x86-64 -msse4.2 -mpopcnt -m64 -fPIC" ],
  ...
  perl_version => "5.36.1",
  perlargv => [ "shared", "no-dso", "no-asm", "android-x86_64", "-D__ANDROID_API__=21" ],
  perlenv => {
